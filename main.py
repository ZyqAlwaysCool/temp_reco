...
def ir_temp_reco(image_path: str):
    ...
    boxes_list, temp_list, contour_list = yolo_ir_predictor.predict(image_path)
    ...
    if DRAW_CONFIGS['is_show']:
        ...
        draw_contour_and_labels(image_path, contour_list, temp_list)
    else:
        for i in range(cnt):
...
if __name__ == '__main__':
    ...
    # real_img_path = '/home/kemove/zyq/giit/yolo_taoguan/temp_reco/img/1.JPG'
    # ir_temp_reco(real_img_path)